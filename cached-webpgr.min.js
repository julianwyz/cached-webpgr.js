 ...
 * License: MIT
 */
 function _lsAvailable(){var t="test";try{return localStorage.setItem(t,t),localStorage.removeItem(t),!0}catch(e){return!1}}
function _cacheScript(e,t,n){var a=new XMLHttpRequest;a.onreadystatechange=function(){4==a.readyState&&(200==a.status?_lsAvailable()&&localStorage.setItem(e,JSON.stringify({content:a.responseText,version:t})):console.warn("error loading "+n))},a.open("GET",n,!0),a.send()}
